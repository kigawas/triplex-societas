...
contract MixinLockCore is MixinRoles, MixinFunds, MixinDisable {
    ...
    function setEventHooks(
        ...
        if (
            _onKeyTransferHook != address(0) && !_onKeyTransferHook.isContract()
        ) {
...
contract MixinGrantKeys is MixinErrors, MixinRoles, MixinKeys {
    ...
    function grantKeys(
        ...
        _lockIsUpToDate();
        if (
            !hasRole(KEY_GRANTER_ROLE, msg.sender) && !isLockManager(msg.sender)
        ) {
    ...
    MixinKeys
{
  ...
  */
    ...
    function isRenewable(
        ...
        uint deadline = (_keys[_tokenId].expirationTimestamp -
            expirationDuration) + // origin
    ...
    MixinPurchase
{
    ...
    function getCancelAndRefundValue(
        ...
        uint timeRemaining = keyExpirationTimestampFor(_tokenId) -
            block.timestamp;
    ...
    MixinConvenienceOwnable
{
    function initialize(
        ...
        MixinConvenienceOwnable._initializeMixinConvenienceOwnable(
            _lockCreator
        );
